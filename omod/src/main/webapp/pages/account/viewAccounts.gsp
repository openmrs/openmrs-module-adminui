...
<script type="text/javascript">
    var breadcrumbs = [
        ...
        { label: "${ ui.message("admintoolsui.app.accountManager.label")}", link: '${ui.pageLink("adminui", "account/manageAccounts")}' },
...
<table id="list-accounts" cellspacing="0" cellpadding="2">
	<thead>
		<tr>
            ...
            <th>${ ui.message("adminui.account.providerIdentifier.label") }</th>
			<th></th>
		</tr>
	</thead>
	<tbody>
