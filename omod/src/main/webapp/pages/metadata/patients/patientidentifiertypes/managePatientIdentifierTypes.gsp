<%
    ...
    ui.includeJavascript("adminui", "metadata/managePatientIdentifierTypes.js")
%>
...
<script type="text/javascript">
    var breadcrumbs = [
        ...
        { label: "${ ui.message("adminui.managePatientIdentifierTypes.title")}" }
    ];
    emr.loadMessages([
        "adminui.saved",
...
<script type="text/javascript">
    angular.bootstrap("#manage-patient-identifier-types", [ "managePatientIdentifierTypes" ])
</script>