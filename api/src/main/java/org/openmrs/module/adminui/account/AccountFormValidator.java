...
public class AccountFormValidator implements Validator {
    ...
    /**
     * @should reject an empty username if user is not null - FALSE
     * @should reject an empty givenname - TRUE
     * @should reject an empty familyname - TRUE
     * @should reject an empty privilegeLevel if user is not null - FALSE
     * @should require password if conform password is provided - TRUE
     * @should require confirm password if password is provided - TRUE
     * @should reject password and confirm password if they dont match - TRUE
     * @should pass for a valid account - TRUE
     * @should pass for a valid account with only person property
     * @should require passwords for a new a user account - TRUE
     * 
     * @should check username, password, confirmpass, priviligelevel, role only if user enabled
     * @should check providerRole only if provider enabled
